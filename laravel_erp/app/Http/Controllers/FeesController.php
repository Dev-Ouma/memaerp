...
final class FeesController extends Controller
{
    ...
    public function paymentAccounts(Request $request): View
    {
        ...
        $accounts = [
            [
                'id' => 1,
                'account_no' => 'MEMA-KCB-PAYBILL',
                'name' => 'KCB M-Pesa Paybill Collection Account',
                'bank_name' => 'Kenya Commercial Bank (KCB)',
                'account_number' => 'Paybill: 522 522 | Account: 0113636154',
                'integration_type' => 'KCB BGF API & M-Pesa IPN',
                'trimester_revenue' => 'KES 24,150,000',
                'status' => 'Operational & Connected',
            ],
            [
                'id' => 2,
                'account_no' => 'MEMA-POCHI-01',
                'name' => 'Admissions Pochi la Biashara Mobile Wallet',
                'bank_name' => 'Safaricom M-Pesa (Pochi)',
                'account_number' => '0113636154',
                'integration_type' => 'Pochi Direct Mobile Wallet C2B',
                'trimester_revenue' => 'KES 4,800,000',
                'status' => 'Operational & Connected',
            ],
            [
                'id' => 3,
                'account_no' => 'MEMA-TILL-01',
                'name' => 'MEMA Buy Goods / Merchant Till',
                'bank_name' => 'Safaricom Lipa na M-Pesa',
                'account_number' => 'Till: 0113636154',
                'integration_type' => 'Merchant Till Webhook Listener',
                'trimester_revenue' => 'KES 6,250,000',
                'status' => 'Operational & Connected',
            ],
            [
                'id' => 4,
                'account_no' => 'MEMA-STK-PUSH',
                'name' => 'Daraja 2.0 Instant STK Push Gateway',
                'bank_name' => 'Safaricom Daraja API',
                'account_number' => 'Endpoint: 0113636154',
                'integration_type' => 'Real-Time C2B API Instant STK Push',
                'trimester_revenue' => 'KES 5,900,200',
                'status' => 'Operational & Connected',
            ],
            [
                'id' => 5,
                'account_no' => 'MEMA-STRIPE-CARD',
                'name' => 'Global Debit & Credit Card Gateway',
                'bank_name' => 'Stripe 3D-Secure 2.0',
                'account_number' => 'Visa • Mastercard • Amex',
                'integration_type' => 'Stripe Elements & Webhooks',
                'trimester_revenue' => 'KES 1,750,000',
                'status' => 'Operational & Connected',
            ],
        ];
