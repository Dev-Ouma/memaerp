...
- Name: iam-admin.spec.ts >> MOD-00-01 IAM administration >> authenticates and renders live protected IAM data
- Location: e2e/iam-admin.spec.ts:13:7
...
Expected: "http://localhost:3015/"
Received: "http://localhost:3015/login"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="en" class="__variable_572227 __variable_eef148">…</html>
       - unexpected value "http://localhost:3015/login"
...
- main:
  - heading "Administration sign in" [level=1]
  - paragraph: Sign in with your institutional account to access ERP administration.
  - alert:
    - img
    - heading "Sign in failed" [level=5]
