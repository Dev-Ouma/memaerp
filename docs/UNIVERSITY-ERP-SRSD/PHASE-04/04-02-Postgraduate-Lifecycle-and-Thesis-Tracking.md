# MOD-04-02: Masters/PhD Lifecycle, Supervisor Allocation & Viva — SOFTWARE REQUIREMENTS SPECIFICATION

- **Module Identifier:** `MOD-04-02`
...
- **Module ID:** `MOD-04-02`
- **Official Name:** Masters/PhD Lifecycle, Supervisor Allocation & Viva
...
Oversees the specialized postgraduate student journey from concept paper submission, supervisor appointment, proposal defense, ethics approval liaison, thesis progress reporting, plagiarism screening, external examination, viva voce scheduling, to final bound thesis deposit.

## 4. Scope
### 4.1 In-Scope
- Postgraduate student milestone tracker (Concept -> Proposal -> Defense -> Thesis -> Viva)
- Academic supervisor allocation and tracking of supervision load
- Periodic progress report submission and supervisor evaluation
- Plagiarism and similarity index report attachment (Turnitin)
- Internal and external examiner appointment and dossier dispatch
- Viva voce oral examination scheduling and scoring panel
- Final corrected thesis submission and institutional repository upload
...
| **Domain Coordinator / Officer** | Operates day-to-day postgraduate directorate workflows, processes applications, and verifies compliance. | Staff |
...
### FR-02-001: Core Masters/PhD Lifecycle, Supervisor Allocation & Viva Management
- **Description:** System shall manage the end-to-end lifecycle for masters/phd lifecycle, supervisor allocation & viva with full compliance and state tracking.
...
### FR-02-002: Masters/PhD Lifecycle, Supervisor Allocation & Viva Reporting and Auditing
...
|---|---|---|
| **SUB-02-01** | Intake & Registration Hub | Handles intake, verification, and initial processing of masters/phd lifecycle, supervisor allocation & viva items. |
| **SUB-02-02** | Review & Evaluation Engine | Manages rubrics, peer reviews, committee evaluations, and scoring. |
| **SUB-02-03** | Milestone & Compliance Tracker | Tracks progress milestones, renewals, SLA deadlines, and closures. |
...
- **BR-MOD-04-02-001 (Conflict of Interest Prevention):** Reviewers and committee members cannot evaluate submissions where they are named investigators, supervisors, or interested parties.
- **BR-MOD-04-02-002 (Document Immutability):** Once approved by committee or authority, final signed documents and certificates cannot be modified without formal amendment workflow.
- **BR-MOD-04-02-003 (Audit Trail Completeness):** Every evaluation score, status update, note, and decision must capture user ID, timestamp, IP address, and previous state.

## 13. Data Requirements & Entities
### Core PostgreSQL Relational Tables:
#### Table: `mod_04_02.primary_records`
*Description: Master data registry for Masters/PhD Lifecycle, Supervisor Allocation & Viva.*
```sql
-- Schema defined in detailed implementation phase
-- Core entity for Masters/PhD Lifecycle, Supervisor Allocation & Viva
...
## 15. Validation Rules
- **VR-MOD-04-02-001 [tracking_number]:** Must follow institutional numbering format e.g. UNIV/MOD/YYYY/XXXXX.
...
- **Masters/PhD Lifecycle, Supervisor Allocation & Viva Executive Dashboard (Deans, Directors, Executive Committee):** Real-time pipeline volume, approval velocity, overdue items, compliance indicators, and strategic KPIs for masters/phd lifecycle, supervisor allocation & viva.

## 19. Reports
| Report ID | Title | Frequency | Output Formats | Permitted Roles |
|---|---|---|---|---|
| `REP-02-01` | Masters/PhD Lifecycle, Supervisor Allocation & Viva Master Register | Monthly / On-Demand | PDF, Excel, CSV | Management, Auditors, Regulators |
| `REP-02-02` | Masters/PhD Lifecycle, Supervisor Allocation & Viva Performance & SLA Report | Quarterly | PDF, CSV | Quality Assurance, Senate |
...
GET  /api/v1/04/02
POST /api/v1/04/02
GET  /api/v1/04/02/reports
GET  /api/v1/04/02/dashboard
```
...
- **Inbound Dependencies (Prerequisites):** MOD-01-06 (Student Records), MOD-01-03 (Curriculum), MOD-03-01 (Faculty Staff)
- **Outbound Dependencies (Consuming Modules):** MOD-01-12 (Graduation Clearance), MOD-04-03 (Ethics Review), MOD-04-06 (DMS Repository).

## 25. System-Generated Documents
- **Masters/PhD Lifecycle, Supervisor Allocation & Viva Official Documentation:** Format `PDF`. Standardized output certificates, transcripts, notices, and approval summaries for masters/phd lifecycle, supervisor allocation & viva.
...
|---|---|---|---|
| `ERR-02-001` | `400 Bad Request` | Missing mandatory documentation or invalid parameters | Highlight missing checklist items in UI. |
| `ERR-02-002` | `403 Forbidden` | Reviewer conflict of interest or unauthorized status change | Block action and log security warning in audit log. |
...
- [ ] **AC-1:** Complete lifecycle workflow for masters/phd lifecycle, supervisor allocation & viva executes without data loss.
...
|---|---|---|---|
| `TC-02-01` | End-to-End Masters/PhD Lifecycle, Supervisor Allocation & Viva Lifecycle | 1. Submit initial dossier. 2. Pass administrative screening. 3. Complete review cycle. 4. Record committee decision. 5. Verify certificate generation. | Submission progresses smoothly across stages and outputs valid signed documentation. |
