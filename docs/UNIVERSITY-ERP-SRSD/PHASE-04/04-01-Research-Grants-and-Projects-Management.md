# MOD-04-01: Research Grants, Proposals & Publication Tracking — SOFTWARE REQUIREMENTS SPECIFICATION

- **Module Identifier:** `MOD-04-01`
...
- **Module ID:** `MOD-04-01`
- **Official Name:** Research Grants, Proposals & Publication Tracking
...
Manages the end-to-end university research portfolio: grant opportunity scouting, proposal preparation, budget formulation, donor compliance, grant disbursement tracking, research project milestones, outputs, and scholarly publications repository.

## 4. Scope
### 4.1 In-Scope
- Grant call indexing and proposal submission portal
- Co-investigator and institutional sign-off workflows
- Grant contract and budget allocation management
- Project milestone and deliverable tracking
- Research expenditure tracking against donor budget lines
- Scholarly publications registry with DOI indexing and impact metrics
- Intellectual property and patent application logging
...
| **Domain Coordinator / Officer** | Operates day-to-day research division workflows, processes applications, and verifies compliance. | Staff |
...
### FR-01-001: Core Research Grants, Proposals & Publication Tracking Management
- **Description:** System shall manage the end-to-end lifecycle for research grants, proposals & publication tracking with full compliance and state tracking.
...
### FR-01-002: Research Grants, Proposals & Publication Tracking Reporting and Auditing
...
|---|---|---|
| **SUB-01-01** | Intake & Registration Hub | Handles intake, verification, and initial processing of research grants, proposals & publication tracking items. |
| **SUB-01-02** | Review & Evaluation Engine | Manages rubrics, peer reviews, committee evaluations, and scoring. |
| **SUB-01-03** | Milestone & Compliance Tracker | Tracks progress milestones, renewals, SLA deadlines, and closures. |
...
- **BR-MOD-04-01-001 (Conflict of Interest Prevention):** Reviewers and committee members cannot evaluate submissions where they are named investigators, supervisors, or interested parties.
- **BR-MOD-04-01-002 (Document Immutability):** Once approved by committee or authority, final signed documents and certificates cannot be modified without formal amendment workflow.
- **BR-MOD-04-01-003 (Audit Trail Completeness):** Every evaluation score, status update, note, and decision must capture user ID, timestamp, IP address, and previous state.

## 13. Data Requirements & Entities
### Core PostgreSQL Relational Tables:
#### Table: `mod_04_01.primary_records`
*Description: Master data registry for Research Grants, Proposals & Publication Tracking.*
```sql
-- Schema defined in detailed implementation phase
-- Core entity for Research Grants, Proposals & Publication Tracking
...
## 15. Validation Rules
- **VR-MOD-04-01-001 [tracking_number]:** Must follow institutional numbering format e.g. UNIV/MOD/YYYY/XXXXX.
...
- **Research Grants, Proposals & Publication Tracking Executive Dashboard (Deans, Directors, Executive Committee):** Real-time pipeline volume, approval velocity, overdue items, compliance indicators, and strategic KPIs for research grants, proposals & publication tracking.

## 19. Reports
| Report ID | Title | Frequency | Output Formats | Permitted Roles |
|---|---|---|---|---|
| `REP-01-01` | Research Grants, Proposals & Publication Tracking Master Register | Monthly / On-Demand | PDF, Excel, CSV | Management, Auditors, Regulators |
| `REP-01-02` | Research Grants, Proposals & Publication Tracking Performance & SLA Report | Quarterly | PDF, CSV | Quality Assurance, Senate |
...
GET  /api/v1/04/01
POST /api/v1/04/01
GET  /api/v1/04/01/reports
GET  /api/v1/04/01/dashboard
```
...
- **Inbound Dependencies (Prerequisites):** MOD-01-01 (IAM), MOD-03-01 (Staff data), MOD-03-07 (GL Finance)
- **Outbound Dependencies (Consuming Modules):** MOD-03-08 (Grant AP disbursements), MOD-05-02 (Data Warehouse).

## 25. System-Generated Documents
- **Research Grants, Proposals & Publication Tracking Official Documentation:** Format `PDF`. Standardized output certificates, transcripts, notices, and approval summaries for research grants, proposals & publication tracking.
...
|---|---|---|---|
| `ERR-01-001` | `400 Bad Request` | Missing mandatory documentation or invalid parameters | Highlight missing checklist items in UI. |
| `ERR-01-002` | `403 Forbidden` | Reviewer conflict of interest or unauthorized status change | Block action and log security warning in audit log. |
...
- [ ] **AC-1:** Complete lifecycle workflow for research grants, proposals & publication tracking executes without data loss.
